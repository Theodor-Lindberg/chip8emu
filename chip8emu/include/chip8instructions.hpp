...
public:
	...
	bool execute(const uint16_t& op_code);
...
private:
	...
	void SE_VxByte(const uint16_t& op_code) const;
	...
	/// <param name="adress"> The operation code. </param>
	void ADD_Vx_Vy(const uint16_t& op_code) const;
	...
	/// <param name="adress"> The operation code. </param>
	void SUB_Vx_Vy(const uint16_t& op_code) const;
	...
	/// <param name="adress"> The operation code. </param>
	void SHR_Vx_Vy(const uint16_t& op_code) const;
	...
	/// <param name="adress"> The operation code. </param>
	void SUBN_Vx_Vy(const uint16_t& op_code) const;
