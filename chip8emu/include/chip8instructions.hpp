...
/// <param name="op_code"> The operation code. </param>
void ADD_Vx_Vy(const uint16_t& op_code);
...
/// <param name="op_code"> The operation code. </param>
void SUB_Vx_Vy(const uint16_t& op_code);
...
/// <param name="op_code"> The operation code. </param>
void SHR_Vx_Vy(const uint16_t& op_code);
...
void SUBN_Vx_Vy(const uint16_t& op_code);
